...
class Generator(nn.Module):
    ...
    def __init__(self, num_features=256, dim_z=100, bottom_width=4,
        ...
        self.block2 = G_Block(num_features , num_features,
...
class Discriminator(nn.Module):
    ...
    def __init__(self, num_features=256, num_classes=0, activation=F.relu):
        ...
        self.block4 = D_Block(num_features, num_features ,
                            activation=activation, downsample=True)
        self.block5 = D_Block(num_features, num_features ,
                            activation=activation, downsample=True)
        #self.l6 = utils.spectral_norm(nn.Linear(num_features * 16, 1))
        self.l6 = nn.Linear(num_features, 1)
        self._initialize()
