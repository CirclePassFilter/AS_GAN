...
class Generator(nn.Module):
    ...
    def __init__(self, num_features=64, dim_z=100, bottom_width=4,
        ...
        self.block3 = G_Block(num_features * 8, num_features * 4,
                            activation=activation, upsample=True,
                            num_classes=num_classes)
        self.block4 = G_Block(num_features * 4, num_features * 2,
                            activation=activation, upsample=True,
                            num_classes=num_classes)
        self.block5 = G_Block(num_features * 2, num_features,
                            activation=activation, upsample=True,
                            num_classes=num_classes)
...
class Discriminator(nn.Module):
    ...
    def __init__(self, num_features=96, num_classes=0, activation=F.relu):
        ...
        self.block2 = D_Block(num_features, num_features * 2,
                            activation=activation, downsample=True)
        self.block3 = D_Block(num_features * 2, num_features * 4,
                            activation=activation, downsample=True)
        self.block4 = D_Block(num_features * 4, num_features * 8,
                            activation=activation, downsample=True)
